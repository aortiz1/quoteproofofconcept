...
<body>
    <%--action="../../cgi-bin/nph-cqs32.exe"--%>
    <form name="startform" action="../public_html/cgi-bin/nph-cqs32.exe" id="form1" method="post" enableviewstate="false">
...
your *.HTM files.  The *.HTM files will be in the COMPLIFE\USER\USER2 directory -->
        <input type="hidden" name="UserLocation" value="\public_html\cgi-bin\COMPLIFE\USER\USER2" />
